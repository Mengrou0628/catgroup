...
session_start();
//$res=mysqli_query($conn,"select project_id,projectname,team_id from protm");//取团队项目表里的全部数据
$res=mysqli_query($conn,"select project_id,projectname, team_id from protm where `user_id`='{$_SESSION['user_id']}'");//取个人项目表里的全部数据
$arr = array();	
if($res){
